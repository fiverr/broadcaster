...
ReleaseNotes.prototype.generateSingleUpdate = function generateSingleUpdate(update){
    var update = "<p><b><span style='color:OliveDrab'>" + update.feature_type + " Update</span></b></p>"
      + "<p><b><span style='color:orange'>" + update.fix_or_new + "</span> " + update.update_title + "</b><br/>"
